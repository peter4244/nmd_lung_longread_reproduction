...
# - Our model predictions: pulled from the deposit's
#     predictions_atg1000_stop1000_seed42_all.tsv (see PREDS below). The 500nt model this line
#     used to name is superseded and is not in the deposit.
# =============================================================================
