...
def build_figure():
    long = pd.read_csv(HERE.parent / "data" / "panelD_longest_5utr_orf_long.tsv", sep="\t")
    stats = pd.read_csv(HERE.parent / "data" / "panelD_longest_5utr_orf_pairwise.tsv", sep="\t")
    desc = pd.read_csv(HERE.parent / "data" / "panelD_longest_5utr_orf_descriptives.tsv", sep="\t")
...
def main():
    ...
    out_dir = HERE.parent
    fig.savefig(out_dir / "figure4_panelD_longest_5utr_orf_refaug.pdf", facecolor="white")
    fig.savefig(out_dir / "figure4_panelD_longest_5utr_orf_refaug.png", dpi=300, facecolor="white")
    print("Saved: figure4_panelD_longest_5utr_orf_refaug.{pdf,png}")
