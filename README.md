...
| **The Zenodo archive** ([10.5281/zenodo.21544336](https://doi.org/10.5281/zenodo.21544336)) | the starting data — 15 downloads (10 files and 5 archives), 695 MB compressed, 4.6 GB once extracted |
...
Fifteen files: ten you download directly, five that are zipped folders.
...
See [`CITATION.cff`](CITATION.cff). Cite the paper for the findings and the Zenodo archive for the
data; this code is archived alongside them.
